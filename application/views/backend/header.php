...
<div class="navbar-custom topnav-navbar topnav-navbar-dark">
    <div class="container-fluid">
        ...
        <!-- LOGO -->
        <a href="<?php echo site_url(); ?>" class="topnav-logo" style = "min-width: unset;">
        ...
        <div class="app-search dropdown pt-1 mt-2">
            ...
            <a href="<?php echo site_url(); ?>" target="_blank" class="btn btn-outline-light ms-2 d-none d-md-inline-block"><?php echo get_phrase('visit_website'); ?></a>
        </div>
